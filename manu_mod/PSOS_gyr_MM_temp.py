...
#plt.rcParams.update({'font.size': 10, 'font.family': 'Arial','font.style':'italic'})#,'font.serif':'Times New Roman'})
...
if(1):
	...
	ax1.set_xticks([0.2,0.6,1.0])#np.arange(0.0,1.21,0.2))
	ax1.yaxis.set_label_coords(-0.03,0.44)#(-0.13,0.44)
	ax1.set_yticks([])
