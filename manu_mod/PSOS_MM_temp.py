...
X = data[:,0]
PX = data[:,1]
ax.scatter(X,PX,s=ms,color='olivedrab',rasterized=True)
...
ax.set_title(r'$T=0.95T_c$', fontsize=ti_fs,x=0.5,y=0.83)
	
fig.set_size_inches(3,2)
fig.savefig('/home/vgs23/Images/PSOS_RP_0.95Tc_Leverhulme.pdf'.format(g), dpi=400, bbox_inches='tight',pad_inches=0.0)
plt.show()	
