...
m = 1
w = 1.0 #quadratic term (frequency)
a = 0.02 #cubic term
b = 0.0 #quartic term
...
fig.suptitle(r'$Harmonic \: + \: Cubic \; Perturbation$',fontsize=13)
...
fig.savefig('Harmcubic_allbeta.png',dpi=400,bbox_inches='tight',pad_inches=0.0)
plt.show()
