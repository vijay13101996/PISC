...
for pot in ['box','lorenz']:
    ...
    if(1):
        ...
        C_arr = OTOC_f_2D_omp_updated.otoc_tools.lambda_corr_arr_t(vecs,m,x_arr,DVR.dx,DVR.dy,k_arr,vals,m_arr,tarr,beta,n_eigen,'xxC',0.5,C_arr)
