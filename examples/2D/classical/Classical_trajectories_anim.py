...
ax.contour(xgrid,ygrid,potgrid,levels=np.arange(-0.3,0.85*D,D/10),cmap='jet',alpha=0.65,linewidths=1.0)	
ax.scatter(instanton[0,0],instanton[0,1],color='m', s=10)	
...
scatter2 = plt.scatter(xb,yb,s=msl,facecolor='r',edgecolor='r',alpha=0.35,zorder=3)
timeax = plt.annotate('t=0.0', xy=(3.75, 3.1), xytext=(0.81, 0.9),xycoords = 'axes fraction',fontsize=xl_fs)
...
fig.set_size_inches(6,4)#2.4, 1.6)	
...
#anim.save('{}/Chaotic_Instanton_v2.mp4'.format(path),dpi=200,fps=20,bitrate=-1, codec="libx264")
anim.save('{}/Chaotic_Instanton_v2.gif'.format(path),dpi=150,fps=20,writer='imagemagick')#bitrate=-1, codec="libx264")
plt.show()
