...
def plot_kubo(path,alpha,D,lamda,g,z,beta,ax,lbltxt,basis_N=50,n_eigen=20,k=1.0):
	...
	potkey = 'double_well_2D_alpha_{}_D_{}_lamda_{}_g_{}_z_{}'.format(alpha,D,lamda,g,z)
	fname = 'Quantum_Kubo_OTOC_{}_beta_{}_neigen_{}_basis_{}'.format(potkey,beta,n_eigen,basis_N)
