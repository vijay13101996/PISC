...
time_run = 1000#CONVERGENCE PARAMETER#todo:vary
...
dq_cent = 0.00001*np.ones_like(q)#todo:vary
dp_cent = np.zeros_like(p)#todo:vary
...
T_arr = np.linspace(0.5, 0.8, 4)

#qcart = read_arr('Instanton_{}_{}_nbeads_{}'.format(potkey,'T_0.95Tc',32),'{}/Datafiles'.format(path)) #instanton	
