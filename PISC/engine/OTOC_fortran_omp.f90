module position_matrix	
	...
	contains
		...
		subroutine b_matrix_elts(vecs,len1vecs,len2vecs,mass,x_arr,lenx,dx,dy,k_arr,lenk,vals_arr,lenv,n,m,t,b_mat_elt)
		...
		subroutine compute_b_mat_arr_m(vecs,len1vecs,len2vecs,mass,x_arr,lenx,dx,dy,k_arr,lenk,vals_arr,lenv,n,m_arr,lenm,t,b_mat)
			...
			!$OMP PARALLEL DO PRIVATE(i)
			do i=1,lenm
				call b_matrix_elts(vecs,len1vecs,len2vecs,mass,x_arr,lenx,dx,dy,k_arr,lenk,vals_arr,lenv,n,m_arr(i),t,b_mat(i))
			end do
			!$OMP END PARALLEL DO
		...
		subroutine compute_c_mc_arr_n(vecs,len1vecs,len2vecs,mass,x_arr,lenx,dx,dy,k_arr,lenk, &
					vals_arr,lenv,n_arr,lenn,m_arr,lenm,t,c_mc_mat)
			...
			!$OMP PARALLEL DO PRIVATE(i)
			do i=1,lenn
				call c_mc_elts(vecs,len1vecs,len2vecs,mass,x_arr,lenx,dx,dy,k_arr,lenk,vals_arr,lenv,n_arr(i),m_arr,lenm,t,c_mc_mat(i))
			end do
			!$OMP END PARALLEL DO
		...
		subroutine compute_c_mc_arr_t(vecs,len1vecs,len2vecs,mass,x_arr,lenx,dx,dy,k_arr,lenk, &
			...
			!$OMP PARALLEL DO PRIVATE(i)
			do i=1,lent
				call c_mc_elts(vecs,len1vecs,len2vecs,mass,x_arr,lenx,dx,dy,k_arr,lenk,vals_arr,lenv,n,m_arr,lenm,t_arr(i),c_mc_mat(i))
			end do
			!$OMP END PARALLEL DO
		end subroutine compute_c_mc_arr_t

		subroutine OTOC_elts(vecs,len1vecs,len2vecs,mass,x_arr,lenx,dx,dy,k_arr,lenk, &
					vals_arr,lenv,m_arr,lenm,t,beta,n_eigen,OTOC_elt)
			...
			do i=1,n_eigen
				call c_mc_elts(vecs,len1vecs,len2vecs,mass,x_arr,lenx,dx,dy,k_arr,lenk,vals_arr,lenv,i-1,m_arr,lenm,t,c_mc_mat(i))
				OTOC_elt = OTOC_elt + (1/Z)*exp(-beta*vals_arr(i))*c_mc_mat(i)
			end do

		end subroutine OTOC_elts

		subroutine compute_OTOC_arr_t(vecs,len1vecs,len2vecs,mass,x_arr,lenx,dx,dy,k_arr,lenk, &
					vals_arr,lenv,m_arr,lenm,t_arr,lent,beta,n_eigen,OTOC_mat)	
			...
			!$OMP PARALLEL DO PRIVATE(i)
			do i=1,lent
				call OTOC_elts(vecs,len1vecs,len2vecs,mass,x_arr,lenx,dx,dy,k_arr,lenk,&
						vals_arr,lenv,m_arr,lenm,t_arr(i),beta,n_eigen,OTOC_mat(i))
			end do
			!$OMP END PARALLEL DO
		end subroutine compute_OTOC_arr_t

		subroutine Kubo_OTOC_elts(vecs,len1vecs,len2vecs,mass,x_arr,lenx,dx,dy,k_arr, &
					lenk,vals_arr,lenv,m_arr,lenm,t,beta,n_eigen,OTOC_elt)
			...
			do n=1,n_eigen
				do m=1,n_eigen
					b_nm = 0.0
					call b_matrix_elts(vecs,len1vecs,len2vecs,mass,x_arr,lenx,dx,dy,k_arr,lenk,vals_arr,lenv,n,m,t,b_nm)
					!OTOC_elt = OTOC_elt + &
		...
		subroutine compute_Kubo_OTOC_arr_t(vecs,len1vecs,len2vecs,mass,x_arr,lenx,dx,dy,k_arr,lenk,vals_arr,lenv, &
			...
			!$OMP PARALLEL DO PRIVATE(i)
			do i=1,lent
				call Kubo_OTOC_elts(vecs,len1vecs,len2vecs,mass,x_arr,lenx,dx,dy,k_arr,lenk,vals_arr,lenv&
