...
def main(pathname,sysname,potkey,pes,Tkey,T,m,dim,N,nbeads,dt_therm,dt,rngSeed,time_therm,time_total,corrkey,tau0=0.1,pile_lambda=1000.0):
	...
	if(corrkey=='OTOC'):
		fname = 'RPMD_OTOC_{}_{}_T_{}_N_{}_nbeads_{}_dt_{}_seed_{}'.format(sysname,potkey,Tkey,N,nbeads,dt,rngSeed)
		store_1D_plotdata(tarr,Mqqarr,fname,'{}/Datafiles'.format(pathname))
	else:
		fname = 'RPMD_{}_TCF_{}_{}_T_{}_N_{}_nbeads_{}_dt_{}_seed_{}'.format(corrkey,sysname,potkey,Tkey,N,nbeads,dt,rngSeed)
