...
from PISC.engine.filter import Rg_Filter
...
def generate_rp_gyr(pathname,m,dim,N,nbeads,ens,pes,rng,time_relax,dt_relax,potkey,rngSeed,E,qlist,gyr_lower=0,gyr_upper=0.2,hist=False):
	...
	store_arr(rp.qcart[logic_filter,:,:],'Filtered_MC_rp_qcart_N_{}_nbeads_{}_beta_{}_{}_seed_{}_rg_min{}_rg_max{}'.format(rp.nsys,rp.nbeads,ens.beta,potkey,rngSeed,gyr_lower,gyr_upper),"{}/Datafiles".format(pathname))
	store_arr(rp.qcart[logic_filter,:,:],'Filtered_MC_rp_pcart_N_{}_nbeads_{}_beta_{}_{}_seed_{}_rg_min{}_rg_max{}'.format(rp.nsys,rp.nbeads,ens.beta,potkey,rngSeed,gyr_lower,gyr_upper),"{}/Datafiles".format(pathname)) 
